...
import br.com.lab.impacta.investment.domain.exception.InvestmentAccountWithoutBalanceForProductPrivate;
...
public class InvestmentExceptionHandler {
    ...
    @ExceptionHandler(InvestmentAccountWithoutBalanceForProductPrivate.class)
